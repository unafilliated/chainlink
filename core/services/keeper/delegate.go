...
func (d *Delegate) ServicesForSpec(spec job.Job) (services []job.Service, err error) {
	...
	contractWrapper, err := NewUniversalContractWrapper(spec.KeeperSpec.ContractVersion, contractAddress.Address(), chain.Client())
	if err != nil {
		return nil, errors.Wrap(err, "while generating universal contract wrapper")
	}
